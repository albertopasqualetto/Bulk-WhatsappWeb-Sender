        ...
        .prompt([
            {
                ...
                name: 'numbers',
                message: "Select the file with telephone numbers (They must be written with county code as a prefix and comma(,) separated) (Confirm with \'Enter\'):",	//Implement sending all media in a folder
            },
            {
                type: 'input',
                name: 'message',
